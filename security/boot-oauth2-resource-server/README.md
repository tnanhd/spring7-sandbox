...
A Spring Boot application for demonstrating OAuth2 authentication and authorization. A simple react app will be served
as static files.

## Description

This project is a sandbox for learning Spring Security with OAuth2 integration. It includes basic setup for OAuth2 login
and resource protection. Authorization server will be using Keycloak, and the application will act as a resource server
...
3. Create a new client: myclient
